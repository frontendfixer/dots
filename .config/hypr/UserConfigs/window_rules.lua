...
wr({ match = { class = "^(firefox|Firefox|Navigator|chromium|chromium-browser|Chromium|[Gg]oogle-chrome(-beta|-dev|-unstable)?|[Bb]rave-browser|qutebrowser|[Hh]elium)$" }, workspace = "3" })
...
wr({ match = { class = "(codium|codium-url-handler|VSCodium|code-oss)", title = "Add Folder to Workspace" }, float = true })
wr({ match = { class = "electron", title = "Add Folder to Workspace" }, float = true })
...
wr({ match = { class = "^(codium-url-handler|code-url-handler|VSCodium-url-handler)$" }, float = true })
...
wr({ match = { class = "^(VSCodium|codium-url-handler|code-oss)$" }, opacity = "0.9 0.7" })
...
wr({ match = { class = "^(VSCode|code-url-handler)$" }, opacity = "0.9 0.8" })
...
wr({ match = { class = "^(gnome-system-monitor|org.gnome.SystemMonitor|io.missioncenter.MissionCenter)$" }, opacity = "0.82 0.75" })
