...
local var = {
	...
	rofi_prompt = "rofi -modi drun -show drun -config ~/.config/rofi/themes/col_singlerow.rasi",
	dmenu_prompt = string.format(
		"dmenu_run -nb '#1a1e1e' -sf '#212128' -sb '#f24054' -nf '#00e5ff' -fn 'Cascadia Code 9' -p 'Applications:'"
	),
	rofimoji_prompt =
	"rofimoji --prompt='Emoji' --selector-args='-theme /home/lakshmi/.config/rofi/themes/emoji-selector.rasi' --hidden-descriptions",
