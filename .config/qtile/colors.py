...
def flatCol():
    colors = [
     		   ["#1a1a1e", "#1a1a1e"],  #background (dark grey) [0]
			   ["#565656", "#565656"],  #light grey [1]
			   ["#eeeef4", "#eeeef4"],  #forground (white) [2]
			   ["#7aa2f7", "#7aa2f7"],  #blue/grey) [3]
			   ["#63fff7", "#63fff7"],  #cyan [4]
			   ["#ABE9B3", "#ABE9B3"],  #green [5]
			   ["#ffc370", "#ffc370"],  #orange [6]
			   ["#fc88d1", "#fc88d1"],  #pink [7]
			   ["#ff3dff", "#ff3dff"],  #purple [8]
			   ['#ff8fad', '#ff8fad'],  #red [9]
			   ["#FAE3B0", "#FAE3B0"]  #yellow [10]
	]
    backgroundColor = "#1a1a1e"
    foregroundColor = "#212128"
    workspaceColor = "#64fccc"
    foregroundColorTwo = "#f8f8f8"
    return colors, backgroundColor, foregroundColor, workspaceColor,foregroundColorTwo

#mbfs
def mbfs():
	colors = [
     		   ["#1d1d26", "#1d1d26"],  #background (dark grey) [0]
	...
	foregroundColor = "#2e313d"
	workspaceColor = "#0adb86"
	foregroundColorTwo = "#cacbda"
	return colors, backgroundColor, foregroundColor, workspaceColor, foregroundColorTwo
...
def everforest():
	...
	foregroundColor = "#2d353b"
	workspaceColor = "#A7C080"
	foregroundColorTwo = "#D5C9AB"
	return colors, backgroundColor, foregroundColor, workspaceColor, foregroundColorTwo
...
foregroundColor =colorscheme[2]
workspaceColor =colorscheme[3]
foregroundColorTwo =colorscheme[4]
